export const QuestionBrData = [
  ...
  {
    question: 'Sou morena, tenho mechas posso utilizar a linha Violeta Seda Protein <h6 class="titulo_facinnius">Facinnius</h6>?',
    answer: 'Sim, pois o Kit Violeta Seda Protein <h6 class="titulo_facinnius">Facinnius</h6> é indicado para todos os tipos de mechas.'
  },
  {
    question: 'Os shampoos <h6 class="titulo_facinnius">Facinnius</h6> podem ser utilizados em crianças?',
  ...
  {
    question: 'Como aplicar o leave-in Leite Siliconado Mar e Piscina <h6 class="titulo_facinnius">Facinnius</h6> corretamente?',
  ...
  {
    question: 'Para que servem as máscaras de tratamento <h6 class="titulo_facinnius">Facinnius</h6>?',
  ...
  {
    question: 'Posso aplicar o Bifásico Infinity One <h6 class="titulo_facinnius">Facinnius</h6> com os cabelos molhados?',
  ...
  {
    question: 'Tenho progressiva a <h6 class="titulo_facinnius">Facinnius</h6> possui alguma linha especifica?',
  ...
  },
  {
    ...
    answer: 'A nossa coloração profissional Kolore <h6 class="titulo_facinnius">Facinnius</h6>, tem como fundo de clareamento o violeta frio. Para informações sobre o assunto você encontrará em nossas redes sociais.'
  },
  {
    question: 'Os produtos <h6 class="titulo_facinnius">Facinnius</h6> possuem nano tecnologia',
  ...
  {
    question: 'A <h6 class="titulo_facinnius">Facinnius</h6> tem progressiva orgânica?',
